...
if __name__ == "__main__":
    # pdf input path
    pdf_input_directory = "./../data/input/"
    pdf_file_names = ["presentatie_verdediging_demo2"]

    # output path to store pdfs with object ids
    drawn_pdf_file_output_directory = "./../data/object_id_on_pdf/"

    # convert to xmls
    for pdf_file_name in pdf_file_names:
        # xml output path
        xml_output_directory = f"./../data/xmls/{pdf_file_name}/"
        print(os.listdir(xml_output_directory))
