...
from src.foil.foil_multi_development import foil_multi_development
...
def learn_rules_from_pdf(input_file_name):
    ...
    for target_relation_name, target_relation in config[input_file_name].items():
        rule_groups = foil_multi_development(target_relation, base_relation_name_to_base_relations, all_objects)
