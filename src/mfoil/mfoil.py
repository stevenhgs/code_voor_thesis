...
def mfoil(target_relation, base_relation_name_to_base_relations, all_objects, beam_size):
    MAX_LENGTH = 10
    ...
    while positive_examples:
        ...
        # tuple of expected accuracy, rule, current_pos, current_neg, current_nb_variables
        ...
        while best_clauses and length < MAX_LENGTH:
            ...
            for expected_accuracy, _, rule, current_positive_examples, current_negative_examples, nb_current_variables in best_clauses:
                ...
                for literal_candidate in literal_candidates:
                    ...
                    nb_positive_examples = get_nb_of_truncated_examples(new_positive_examples, nb_base_variables)
                    nb_negative_examples = get_nb_of_truncated_examples(new_negative_examples, nb_base_variables)
            ...
            for clause_info in new_best_clauses:
                ...
                nb_positive_examples = get_nb_of_truncated_examples(current_positive_examples, nb_base_variables)
                nb_negative_examples = get_nb_of_truncated_examples(current_negative_examples, nb_base_variables)
                print(clause_info)
                print(calculate_significance(nb_positive_examples, nb_negative_examples, prior_positive_probability))
        ...
        if expected_accuracy > prior_positive_probability:
            print("prio", prior_positive_probability)
            learned_rules.append((expected_accuracy, rule))
        else:
            break
...
if __name__ == "__main__":
    ...
    print(mfoil(target_relation, base_relations, [0, 1, 2, 3, 4, 5], beam_size=5))
