...
if __name__ == "__main__":
    for beam_size in beam_sizes:
        for min_significance in min_significances:
            ...
            json_save_path = f'./results/only_positions/'
            current_name = ""
            ...
            for name, config in input_data:
                try:
                    ...
                    filtered_names = filter_max_objects(all_pdf_file_names, input_xml_path, 15)
                    ...
                    nb_iters = math.ceil(len(filtered_names) * 0.31)
