...
def experiment_v2(all_pdf_file_names, xml_path, config, heuristic_function, nb_iters=None, beam_size=10, min_significance=5):
    """
    ...
    for iteration in range(nb_iters+1):
        ...
        for complex_relation_name in complex_relation_names:
            ...
            # metrics
            current_rules = learn_rules_and_add_train_accuracy_v2(selected_slides, xml_path, config, beam_size, min_significance, complex_relation_name)
            # filter rules
            filtered_rules = []
