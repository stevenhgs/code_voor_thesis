...
"Together": Relation("Together", 2, {(2, 1), (5, 4), (10, 9)}),
    },
"US5_2": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, {(3, 2), (4, 3), (5, 4), (8, 5), (9, 8), (11, 9), (12, 11), (14, 12)}),
"Together": Relation("Together", 2, {(6, 5), (7, 5), (10, 9), (13, 12)}),
    },
"US5_3": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, {(3, 1), (9, 3), (11, 9)}),
"Together": Relation("Together", 2, {(2, 1), (4, 3), (5, 3), (6, 3), (7, 3), (8, 3), (10, 9), (12, 11), (13, 11), (14, 11)}),
    },
"US5_4": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, {(3, 2), (4, 3), (6, 4), (8, 6), (10, 8), (11, 10), (14, 11)}),
"Together": Relation("Together", 2, {(5, 4), (7, 6), (9, 8), (12, 11), (13, 11), (15, 14)}),
    },
"US5_5": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, {(3, 1), (4, 3), (5, 4), (6, 5), (8, 6), (9, 8), (10, 9), (11, 10), (12, 11)}),
"Together": Relation("Together", 2, {(2, 1), (7, 6), (13, 12), (14, 12), (15, 12)}),
    },
"US5_6": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, {(2, 1), (4, 2), (5, 4), (7, 5), (10, 7), (13, 10), (15, 13), (16, 15), (17, 16), (19, 17), (22, 19)}),
"Together": Relation("Together", 2, {(3, 2), (6, 5), (8, 7), (9, 7), (11, 10), (12, 10), (14, 13), (18, 17), (20, 19), (21, 19), (23, 22)}),
    },
"US5_7": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, {(2, 1), (3, 2), (5, 3), (6, 5), (7, 6), (10, 7), (11, 10), (12, 11)}),
"Together": Relation("Together", 2, {(4, 3), (9, 6), (8, 7), (13, 12), (14, 12), (15, 12)}),
    },
"US5_8": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, {(2, 1), (3, 2), (5, 3), (7, 5), (8, 7), (9, 8), (11, 9)}),
"Together": Relation("Together", 2, {(4, 3), (6, 5), (10, 9), (12, 11), (13, 11)}),
    },
"US5_9": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, {(3, 1), (4, 3), (5, 4), (6, 5), (7, 6), (8, 7), (9, 8), (10, 9), (13, 2), (14, 13), (15, 14), (16, 15), (17, 16)}),
"Together": Relation("Together", 2, {(12, 2), (11, 10), (18, 10), (19, 20), (20, 10)}),
    },
"US5_10": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, set()),
"Together": Relation("Together", 2, set()),
...
"Together": Relation("Together", 2, {(3, 2), (4, 2), (5, 2), (7, 6), (8, 10), (9, 11), (13, 12), (15, 14), (16, 14)}),
    },
"US5_14": {
        "DirectlyFollows": Relation("DirectlyFollows", 2, set()),
"Together": Relation("Together", 2, set()),
...
"Together": Relation("Together", 2, {(3, 1), (10, 9)}),
    },
}