...
beta = 5
combos = [
    (beta, 0, atleast_one_follows_to_use),
    (beta, 3, atleast_one_follows_to_use),
    (beta, 6, atleast_one_follows_to_use),
]
...
for beam, significance, atleast_one_follows in combos:
    plt.plot(x_points, points[(beam, significance, atleast_one_follows)], label=f"σ={significance}")
