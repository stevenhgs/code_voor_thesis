...
for beam, significance, atleast_one_follows in combos:
    ...
    for percentage in range(max_percentage + 1):
        ...
        for data in all_data:
            ...
            f1_score_to_add, used_to_add, used_slides_to_add = get_score(data["data"], index, False, atleast_one_follows)
...
for beam, significance, atleast_one_follows in combos:
    plt.plot(x_points, points[(beam, significance, atleast_one_follows)], label=f"σ={atleast_one_follows}")
